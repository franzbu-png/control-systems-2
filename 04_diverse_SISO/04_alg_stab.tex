...
\subsection{Hurwitz Kriterium}
    ...
    \begin{equation*}
        ...
        \end{vmatrix}, \, \dots
    \end{equation*}
    positive sind, dann sind alle NST in der linken komplexen Halbebene. %definit sind (alle EW grösser als 0), dann sind alls NST in der linken komplexen Halbebene.
